...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private void setListeners() {
        ...
        binding.button1.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), Stegno1.class));
        });
        binding.button2.setOnClickListener(v -> {
            Toast.makeText(getApplicationContext(), "Button 2 Clicked", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(getApplicationContext(), ImageEncrypt.class));
        });
        binding.button3.setOnClickListener(v -> {
            Toast.makeText(getApplicationContext(), "Button 3 Clicked", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(getApplicationContext(), ImageMasking.class));
        });
    }
